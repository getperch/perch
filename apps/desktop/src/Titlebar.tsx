  ...
  return (
    <div
      ...
      style={{
        ...
        // Sits flush on the app surface — the shell below shares the same background, so the strip
        // reads as one continuous top edge rather than a separate chrome band.
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: 0,
        cursor: "pointer",
        background: hover ? (danger ? "#e5484d" : color.borderLight) : "transparent",
        color: danger && hover ? "#fff" : color.muted,
