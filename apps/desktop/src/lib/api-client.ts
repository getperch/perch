...
export const api = {
  ...
  runs: {
    ...
    listActive: (channelId: string) => invokeApi("runs_list_active", { channelId }, runs.listActiveRunsOutput),
    cancel: (runId: string) => invokeApi("runs_cancel", { runId }, runs.cancelRunOutput),
  },
  workspace: {
