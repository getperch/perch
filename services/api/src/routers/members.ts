...
membersApp.openapi(
  ...
  async (c) => {
    ...
    const agent = {
      ...current,
      ...(patch.name !== undefined ? { name: patch.name, mono: initials(patch.name) } : {}),
      ...(patch.roleDescription !== undefined ? { roleDescription: patch.roleDescription } : {}),
      ...(patch.colorBg !== undefined ? { colorBg: patch.colorBg } : {}),
      ...(patch.colorFg !== undefined ? { colorFg: patch.colorFg } : {}),
