 ...
 * `GET /members/agents/{memberId}/google-workspace/authorize`), and the gmail/calendar tool
 * Lambdas assert their own required scope is present on the refreshed token before calling Google.
 *
